...
const ShellBaseConfigPlugin: PluginOption[] = [
  ...
  cp({
    targets: [
      // Native .node files may be locked by a running QQ/NapCat process on Windows.
      // Avoid overwriting existing native binaries to prevent EPERM unlink failures during rebuild.
      { src: '../napcat-native/', dest: 'dist/native', flatten: false, copyOptions: { overwrite: false } },
